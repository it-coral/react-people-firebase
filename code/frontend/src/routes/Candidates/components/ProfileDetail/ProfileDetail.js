...
export default class ProfileDetailComponent extends Component {
  ...
  render () {
    ...
    let skills = [], 
        education_list = [], 
        experience_list = [], 
        image_url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzfEwtYN4OCSxxbUWDlkcyoiu9r3TErATQOYMS6If9EGPMlZoB'
    ...
    if(profile != {}){
      ...
      if (profile.education_list != undefined) education_list = profile.education_list
      if (profile.experience_list != undefined) experience_list = profile.experience_list
      if (profile.image_url != undefined) image_url = profile.image_url
    }
        ...
        <div className="col-xs-5 col-sm-5 col-md-5">
          <div className="row center-xs center-sm">
              <div className="col-xs-10 col-sm-10">
                  <img src={image_url} className={classes.profile_image} alt="" />
